...
Apart from this, your sampler state should also implement `AbstractMCMC.getparams`:
...
It is quite possible that `getparams` can be implemented without needing to use the model, in which case you can just define `getparams(::Any, spl::T)`.
