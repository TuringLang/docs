...
By default, Turing.jl avoids such a situation from occurring by transforming the constrained parameters to an unconstrained space before passing them to the `externalsampler`.
