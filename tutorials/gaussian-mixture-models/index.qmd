...
The following tutorial illustrates the use of Turing.jl for an unsupervised task, namely, clustering data using a Bayesian mixture model.
...
## Gaussian Mixture Model in Turing.jl
...
We specify the model with Turing.jl.
...
will run sequentially, and you may notice a warning. For more information, see [the Turing.jl documentation on sampling multiple chains.](https://turinglang.org/dev/docs/using-turing/guide/#sampling-multiple-chains)
:::
