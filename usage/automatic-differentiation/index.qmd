...
Turing.jl computes gradients through [AbstractPPL.jl](https://github.com/TuringLang/AbstractPPL.jl)'s [`prepare` / `value_and_gradient!!` interface](https://turinglang.org/AbstractPPL.jl/stable/evaluators/).
...
Turing will automatically perform this preparation for you when calling functions such as `sample` or `optimize`, so you do not need to worry about this step.
:::
