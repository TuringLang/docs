...
Formally, we only run continuous integration tests on the latest patch releases of: (1) the minimum supported minor version (typically an LTS release), and (2) the latest minor version of Julia.
